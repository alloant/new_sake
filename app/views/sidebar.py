...
FULL_MENU['board'] = [
    ...
    MenuGroup(
        title="Proposals",
        items=[
            MenuItem(id="incoming-proposal-to-sign", title="To sign", link="/?section=board&panel=incoming-proposals-to-sign", icon="mdi-pen", perms=["dr","of"]),
            MenuItem(id="incoming-proposal-signed", title="Signed", link="/?section=board&panel=incoming-proposals-signed", icon="mdi-draw-pen", perms=["dr","of"]),
        ]
    ),
    MenuGroup(
        title="My proposals",
        items=[
            ...
            MenuItem(id="outcoming-proposals-circulating", title="Circulating", link="/?section=board&panel=outcoming-proposals-circulating", icon="mdi-file-cabinet", perms=["dr","of"]),
            MenuItem(id="outcoming-proposals-done", title="Done", link="/?section=board&panel=outcoming-proposals-done", icon="mdi-file-cabinet", perms=["dr","of"]),
